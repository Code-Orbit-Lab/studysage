...
def summarize_document(subject_id: str, document_id: str, length: str) -> dict | None:
    return _post(
        "/summarize",
        {"subject_id": subject_id, "document_id": document_id, "length": length},
    )


def generate_quiz(
    subject_id: str, document_id: str, question_count: int, types: list[str]
) -> dict | None:
    return _post(
        "/quiz",
        {
...
def generate_flashcards(
    subject_id: str, document_id: str, card_count: int, difficulty: str
) -> dict | None:
    return _post(
        "/flashcards",
        {
